...
<form class="row" autocomplete="off" method="POST" action="{{ route('customers.update', $customer->id) }}" enctype="multipart/form-data">
    @csrf
    <div class="col-sm-6">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="telephone" value="{{ $customer->telephone }}">
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
    ...
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <textarea rows="4" class="form-control" id="address" name="address">{{ $customer->address }}</textarea>
        </div>
    </div>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            <label for="cr_no" class="col-form-label">CR Number</label>
            <input type="number" class="form-control" name="cr_no" value="{{ $customer->cr_no }}">
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            <label for="cr_reg_date" class="col-form-label">CR Registration Date</label>
            <input type="date" class="form-control issue_date" name="cr_reg_date" value="{{ $customer->cr_reg_date }}">
        </div>
    </div>

    <div class="col-sm-4">
        <div class="form-group">
            <label for="cr_expiry_date" class="col-form-label">CR Expiry Date</label>
            <input type="date" class="form-control expiry_date" name="cr_expiry_date" value="{{ $customer->cr_expiry_date }}">
        </div>
    </div>

    <div class="col-sm-4">
        <div class="form-group">
            <label for="vatin_no" class="col-form-label">Vatin Number</label>
            <input type="text" class="form-control" name="vatin_no" maxlength="12" value="{{ $customer->vatin_no }}">
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            <label for="vatin_reg_date" class="col-form-label">Vatin Registration Date</label>
            <input type="date" class="form-control issue_date" name="vatin_reg_date" value="{{ $customer->vatin_reg_date }}">
        </div>
    </div>
    <div class="col-4">
        <div class="form-group">
            <label for="vatin_expiry_date" class="col-form-label">Vatin Expiry Date</label>
            <input type="date" class="form-control expiry_date" name="vatin_expiry_date" value="{{ $customer->vatin_expiry_date }}">
        </div>
    </div>
            ...
            <table class="table table-bordered text-center mt-3">
                ...
                <tbody id="docs_contain_table">
                    @php
                        $index = 1;
                    @endphp
                    @foreach ($customer->documents as $eq_doc)
                        @php
                            if ($eq_doc->doc_owner_name != 'Customer') {
                                continue;
                            }
    ...
    <div class="col-12 mt-4">
        <input type="submit" class="btn btn-primary btn-rounded float-right" onclick="return validate_date()" value="UPDATE CUSTOMER">
        <a href="{{ route('customers.view') }}" class="btn btn-danger btn-rounded float-right mr-2">CANCEL</a>
    </div>                        
...
<script>
    ...
    function add_row() {
        var elements = `<tr>
                            ...
                            <td><input type="date" class="form-control issue_date" name="doc_issue_date[]"></td>
                            <td><input type="date" class="form-control expiry_date" name="doc_expiry_date[]"></td>
