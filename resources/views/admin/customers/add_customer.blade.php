...
<form class="row" autocomplete="off" method="POST" action="{{ route('customers.store') }}" enctype="multipart/form-data">
    @csrf
    <div class="col-sm-6">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="cr_no">
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            <label for="cr_reg_date" class="col-form-label">CR Registration Date</label>
            <input type="date" class="form-control issue_date" name="cr_reg_date" value="11/04/2020">
        </div>
    </div>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <input type="date" class="form-control expiry_date" name="cr_expiry_date">
        </div>
    </div>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="vatin_no" maxlength="12">
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            <label for="vatin_reg_date" class="col-form-label">Vatin Registration Date</label>
            <input type="date" class="form-control issue_date" name="vatin_reg_date">
        </div>
    </div>
    <div class="col-4">
        <div class="form-group">
            <label for="vatin_expiry_date" class="col-form-label">Vatin Expiry Date</label>
            <input type="date" class="form-control expiry_date" name="vatin_expiry_date">
        </div>
    </div>
    ...
    <div class="col-12 mt-4">
        <input type="submit" class="btn btn-primary btn-rounded float-right" onclick="return validate_date()" value="SAVE CUSTOMER">
