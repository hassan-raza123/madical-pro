...
<form class="row" method="POST" action="{{ route('lpos.store') }}">
    @csrf
    ...
    <div class="col-sm-6">
        <div class="form-group mb-2">
            ...
            <div class="quot_no">
                <input type="number" class="form-control" id="lpo_no" readonly>
                <span class="lpo_no_span" id="lpo_no_span"></span>
                <input type="hidden" name="lpo_no" id="lpo_no_input">
            </div>
        </div>
    </div>
    <div class="col-sm-6">
    ...
    <div class="col-12 mt-3">
        <input type="submit" class="btn btn-primary btn-rounded float-right" value="ADD LPO">
...
<script>
    ...
    $('#lpo_no_span').text('/'+year.toString().substr(-2));
    $(document).ready( () => {
