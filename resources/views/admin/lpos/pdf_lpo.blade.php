...
<body class="bg-white">
    ...
    <div class="container-fluid px-4" id="content">
        ...
        <img src="{{ asset($lpo->company->invoice_bg) }}" class="bg-image">
            ...
            <tbody>
                <tr>
                    <td class="border-right py-4">
                        <img src="{{ asset($lpo->company->signature_img) }}" class="mx-auto d-block" style="height: 70px; width: auto;" alt="Signature Image">
                    </td>
                    <td></td>
                </tr>
            </tbody>
