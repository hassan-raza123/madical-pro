...
<head>
    ...
    <title>Invoice-{{ $inv_no }}-({{ $invoice->company->code }})</title>
...
<body class="bg-white">
    ...
    <div class="container-fluid px-4" id="content">
        ...
        <img src="{{ asset($invoice->company->invoice_bg) }}" class="bg-image">
        ...
        <table>
            ...
            <tbody class="text-cente" style="borde: 1px solid #000;">
                <tr>
                    ...
                    <td style="width: 35%;">{{ $invoice->customer->name }}</td>
                    <td style="width: 12%;" class="border-left">Name:</td>
                    <td style="width: 43%;">{{ $invoice->company->name }}</td>
                </tr>
                <tr>
                    <td>Address:</td>
                ...
                <tr>
                    <td>Vatin:</td>
                    <td>{{ $invoice->customer->vatin_no }}</td>
                    <td class="border-left">Vatin:</td>
                    <td>{{ $invoice->company->vatin }}</td>
                </tr>
                <tr>
        ...
        <table>
            <thead class="text-center border-bottom">
                <th class="border-right" colspan="2">Description</th>
            ...
            <tbody class="text-center">
                ...
                <tr class="border-bottom">
                    <td class="border-right" colspan="2">{{ $invoice->description }}</td>
                    <td class="border-right">{{ $invoice->amount }}</td>
                </tr>

                @for ($i = 0; $i < 15; $i++)
                <tr class="border-bottom">
                    <td class="border-right" colspan="2" style="padding: 15px 0 !important;"></td>
                ...
                <tr>
                    <td class="text-left pl-3"><strong>Bank:</strong> {{ $invoice->company->bank }}</td>
                ...
                <tr>
                    <td style="border: none !important;" class="text-left pl-3"><strong>Account:</strong> {{ $invoice->company->bank_account_no }}</td>
                </tr>
                <tr>
                    <td style="border: none !important;" class="text-left pl-3"><strong>Branch:</strong> {{ $invoice->company->bank_branch }}</td>
                ...
                <tr>
                    <td style="border: none !important;" class="text-left pl-3"><strong>Swift Code:</strong> {{ $invoice->company->bank_swift_code }}</td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    <td class="border-right py-4">
                        <img src="{{ asset($invoice->company->signature_img) }}" class="mx-auto d-block" style="height: 70px; width: auto;" alt="Signature Image">
                    </td>
                    <td></td>
                </tr>
            </tbody>
