...
class Helper
{
    public static function get_expired_docs()
    {
        $documents = expired_docs();
        return $documents;
    }

    public static function get_expired_equipment_docs()
    {
        $documents = expired_docs();
        $docs = [];
    ...
    public static function get_expired_employee_docs()
    {
        $documents = expired_docs();
        $docs = [];
        foreach ($documents as $doc) {
